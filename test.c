...
#define N_BLOCKS 230					  // Number of blocks in the device --> Mete varias con diferentes nombres para pobar mkFS
...
int main()
{
	...
	///////
	ret = includeIntegrity ("/test1.txt");
	if (ret != 0)
	{
